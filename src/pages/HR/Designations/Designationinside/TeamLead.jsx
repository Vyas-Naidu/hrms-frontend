...
const TeamLead = () => {
  ...
  const handleSave = (e) => {
    ...
    console.log("Team Lead:", formData);

    alert("Team Lead designation saved successfully!");
  };

  return (
    <div className={styles.teamLeadContent}>
      ...
      <div className={styles.teamLeadHeader}>
        ...
        <p>
          Add and manage Team Lead designation information.
        </p>
        ...
        <div className={styles.formGrid}>
          ...
          <div className={`${styles.formGroup} ${styles.fullWidth}`}>
            ...
            <textarea
              name="description"
              rows="4"
              placeholder="Enter Team Lead designation description"
