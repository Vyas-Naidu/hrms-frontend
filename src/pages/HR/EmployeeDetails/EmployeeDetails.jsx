...
const EmployeeDetails = () => {
  ...
  if (isLoadingById) {
    return <div className="employee-details-state">Loading employee details...</div>;
  }
    ...
    <section className="employee-details-page">
      ...
      <div className="employee-details-hero">
        <div className="employee-hero-main">
          ...
          <div>
            <p className="details-eyebrow">Employee Details</p>
            <h1>{fullName}</h1>
        ...
        <div className="employee-hero-actions">
          <button type="button" className="details-edit-button" onClick={handleEdit}>
            <Pencil size={17} /> Edit
          </button>
          <button type="button" className="details-delete-button" onClick={handleDelete}>
      ...
      <div className="employee-details-card">
        <div className="details-tabs" role="tablist" aria-label="Employee information">
          {[
            ["personal", "Personal"],
            ["documents", "Documents"],
            ["address", "Address"],
            ...
            <button
              ...
              className={`details-tab ${activeTab === key ? "active" : ""}`}
        ...
        <div className="details-tab-content">
          ...
          {activeTab === "documents" && (
            <div className="details-section">
              <h2>Documents</h2>
              {documentsLoading ? (
                <div className="details-empty">Loading documents...</div>
              ) : documentsError ? (
                <div className="details-error">{documentsError}</div>
              ) : documents.length === 0 ? (
                <div className="details-empty">No documents found for this employee.</div>
              ) : (
                <div className="documents-list">
                  {documents.map((doc) => {
                    ...
                    return (
                      <div className="document-row" key={doc.id || `${name}-${type}`}>
                ...
                <div className="address-block">
                  ...
                  <div className="details-grid">
                    {addressFields(currentAddress).map(([label, value]) => (
                      <div className="detail-field" key={`current-${label}`}>
                        <span>{label}</span>
                        <strong>{value}</strong>
                      </div>
                    ))}
                ...
                <div className="address-block">
                  ...
                  <div className="details-grid">
                    {addressFields(permanentAddress).map(([label, value]) => (
                      <div className="detail-field" key={`permanent-${label}`}>
                        <span>{label}</span>
                        <strong>{value}</strong>
                      </div>
                    ))}
